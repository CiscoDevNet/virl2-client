...
from .utils import _url_from_template, locked
...
class ClientLibrary:
    ...
    def _environ_get(
        ...
        :param value: The value to use if it is already set (optional).
        :param default: The default value to use if the key is not set
            and value is None (optional).
    ...
    def import_lab(
        ...
        :param title: The title of the lab (optional).
