...
def test_lab_requires_user_management() -> None:
    """Require a user management in lab constructor."""
    with pytest.raises(VirlException, match="missing a user management"):
        Lab(
            "test",
            "1",
            MagicMock(),
