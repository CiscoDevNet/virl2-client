...
from virl2_client.models.resource_pools import ResourcePool
...
class LDAPManagement:
    ...
    def sync(self) -> None:
        self._ldap_settings = self.get_current_settings()
    ...
    @property
    def method(self) -> str:
        return self.ldap_settings["method"]
    ...
    def group_membership_filter(self, value: str) -> None:
        ...
        self._ldap_settings["group_membership_filter"] = value

    @property
    def manager_dn(self) -> str:
        return self.ldap_settings["manager_dn"]

    @manager_dn.setter
    def manager_dn(self, value: str) -> None:
        self.update_settings(manager_dn=value)
        self._ldap_settings["manager_dn"] = value

    def manager_password(self, value: str) -> None:
        self.update_settings(manager_password=value)
        self._ldap_settings["manager_password"] = value
    ...
    def email_address_attribute(self, value: str) -> None:
        ...
        self._ldap_settings["email_address_attribute"] = value

    @property
    def resource_pool(self) -> str:
        return self.ldap_settings["resource_pool"]
    ...
    def resource_pool(self, value: str | ResourcePool) -> None:
        ...
        self._ldap_settings["resource_pool"] = value
