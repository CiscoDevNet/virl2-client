...
class ClientLibrary:
    ...
    def __init__(self, url=None, username=None, password=None, ssl_verify=True, raise_for_auth_failure=False, allow_http=False):
        ...
        :param url: URL of controller, including "https://". It's also possible to pass the URL via the VIRL2_URL environment.
        :type url: str
        ...
        :raises InitializationError: If no URL is provided or authentication fails or host can't be reasched
        """
