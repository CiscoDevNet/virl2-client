...
# exclude_patterns = []
exclude_patterns = ["_build", "source/api/virl2_client.rst"]
...
htmlhelp_basename = "virl2_clientdoc"
...
# https://sphinx-hxl.readthedocs.io/en/stable/usage/extensions/autodoc.html
...
# If we have the PCL documented with type hints, then this might
# be the preferred way to generate the documentation.
# This requires sphinx-autoapi to be installed.
# https://sphinx-autoapi.readthedocs.io/en/latest/index.html
# Also, moving to Markdown might be an option going forward, removing
# the need for ReST...
# https://docs.readthedocs.io/en/stable/intro/getting-started-with-sphinx.html#using-markdown-with-sphinx
# https://myst-parser.readthedocs.io/en/latest/index.html
# rschmied July 2022
#
# autoapi_modules = {"virl2_client": {"output": "autogenerated"}}
# autoapi_dirs = [
#     "../../virl2_client",
# ]
# autoapi_root = "api"
